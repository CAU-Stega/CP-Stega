...
def _get_reuters1_classes(args):
    '''
        @return list of classes associated with each split
    '''

    train_classes = list(range(1))
    val_classes = list(range(1))
    test_classes = list(range(1))

    return train_classes, val_classes, test_classes

def _get_stego_bpw_classes(args):
    train_classes = [0,1,2,3]
    val_classes = [0,4,5,6]
    test_classes = [0,7,8,9]#0,7,8,9
    return train_classes, val_classes, test_classes
...
def load_dataset(args):
    ...
    elif args.dataset == 'stego_bpw':
        train_classes, val_classes, test_classes = _get_stego_bpw_classes(args)
    else:
        raise ValueError(
